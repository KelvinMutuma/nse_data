...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { high: @bank.high, low: @bank.low, volume: @bank.volume, war: @bank.war, window_borrowing: @bank.window_borrowing }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { high: @bank.high, low: @bank.low, volume: @bank.volume, war: @bank.war, window_borrowing: @bank.window_borrowing }
    assert_redirected_to bank_path(assigns(:bank))
  end
