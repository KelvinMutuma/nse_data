...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { equity_turnover: @market.equity_turnover, market_capitalization: @market.market_capitalization }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { equity_turnover: @market.equity_turnover, market_capitalization: @market.market_capitalization }
    assert_redirected_to market_path(assigns(:market))
  end
