...
class SecuritiesControllerTest < ActionController::TestCase
  ...
  test "should create security" do
    assert_difference('Security.count') do
      post :create, security: { category: @security.category, security: @security.security, security_code: @security.security_code }
    end
  ...
  test "should update security" do
    patch :update, id: @security, security: { category: @security.category, security: @security.security, security_code: @security.security_code }
    assert_redirected_to security_path(assigns(:security))
  end
